...
class TheBountyWorldSettings(bpy.types.PropertyGroup):
    ...
    bg_color_space = EnumProperty(
            name="Color space",
            items=enum_color_space,
            default="CIE (E)"
    )        
    bg_mapping_type = EnumProperty(
            name="Mapping Type",
            items=enum_mapping_type,
            default='SPHERE'
    )        
    bg_zenith_color = FloatVectorProperty(
            name="Zenith color",
    ...
    bg_horizon_color = FloatVectorProperty(
            name="Horizon color",
    ...
    bg_zenith_ground_color = FloatVectorProperty(
    ...
    bg_horizon_ground_color = FloatVectorProperty(
    ...
    bg_single_color = FloatVectorProperty(
    ...
    v_int_scale = FloatProperty(
            name="Sigma T",
            min=0.0, precision=3,
            description="",
            default=0.100
    )    
    v_int_alpha = FloatProperty(
            name="Alpha",
            min=0.0, precision=3,
            description="",
            default=0.500
    )    
    v_int_dsturbidity = FloatProperty(
            name="Turbidity",
            description="",
            default=3.0
    )
...
def register():
    ...
    bpy.types.World.bounty = PointerProperty(type=TheBountyWorldSettings)
