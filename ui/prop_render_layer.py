...
class TheBountyRenderLayerButtonsPanel():
...
class RENDER_PT_layers(TheBountyRenderLayerButtonsPanel, Panel):
    bl_label = "Layers"
...
'''
class TheBountyRenderLayerLayers(TheBountyRenderLayerButtonsPanel, Panel):
    bl_label = "Layer List"
...
class TheBountyRenderLayerOptions(TheBountyRenderLayerButtonsPanel, Panel):
    bl_label = "Layer"
    COMPAT_ENGINES = {'THEBOUNTY'}
...
class TheBountyRenderLayerPasses(TheBountyRenderLayerButtonsPanel, Panel):
    bl_label = "Passes"
    bl_options = {'DEFAULT_CLOSED'}
    COMPAT_ENGINES = {'THEBOUNTY'}
