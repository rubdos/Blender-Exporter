...
if sys.platform == 'win32':
    for file in os.listdir(BIN_PATH):
        ...
        # load dll's from a MinGW installation
            ...
            dllArray = ['zlib','zlib1', 'libxml2-2', 'libgcc_s_sjlj-1', 'libHalf', 'libIex-2_1', 'libIlmThread-2_1', \
                        'libImath-2_1','libIlmImf-2_1', 'libjpeg-8', 'libpng14', 'libtiff-3', 'libfreetype-6','libstdc++-6', \
